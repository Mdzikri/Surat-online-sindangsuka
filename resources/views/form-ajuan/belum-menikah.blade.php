...
@section('content')
    <div class="container">
      <div class="py-5 text-center">
        <h2 class="orenjudul">Pengajuan Surat Keterangan Belum Menikah</h2>
        <p class="birusubjudul">Untuk pengajuan Surat Keterangan Belum Menikah, Harap isikan data dibawah ini sesuai dengan data pribadi anda.</p>
      </div>
    ...
    @include('layouts.partials.identitas')
      <div class="col-md-7">
        ...
        <form action="{{ route('store') }}" method="post" class="needs-validation">
            @csrf
            <input type="hidden" name="jenis" value="Surat Keterangan Belum Menikah">
            <div class="mb-3">
