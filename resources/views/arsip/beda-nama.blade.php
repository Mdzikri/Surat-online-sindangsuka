...
<body>
    ...
    <table border="0" align="center" style="margin-top: 10px;" width=84%>
        ...
        <tr>
            <td colspan="2">
                <br>
                <center>
                    <u><font size="3"><b>SURAT KETERANGAN BEDA NAMA</b></font></u><br>
    ...
    <table border="0" align="center" width=83% style="padding-left: 30px;">
        ...
        <tr>
            ...
            <td>:</td>
            <td>{{ $user->nama_ayah }} dan {{ $user->nama_ibu }}</td>
        </tr>
        <tr>
            <td>Alamat</td>
            <td>:</td>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    &nbsp;&nbsp;&nbsp;Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa {{ isset($desa) ? $desa->nama_desa : '*atur nama desa' }} Kecamatan {{ isset($desa) ? $desa->kecamatan : '*atur nama kecamatan' }} dan terdapat perbedaan dalam penulisan {{ $ajuan->bedaNama->perbedaan }}, di dalam <b style="text-transform: uppercase">{{ $ajuan->bedaNama->dokumen1 }}</b> tertulis <b style="text-transform: uppercase">{{ $ajuan->bedaNama->data1 }}</b> sedangkan di dalam <b style="text-transform: uppercase">{{ $ajuan->bedaNama->dokumen2 }}</b> tertulis <b style="text-transform: uppercase">{{ $ajuan->bedaNama->data2 }}</b>.
                </p>
            </td>
        </tr>
    </table>
    ...
    <table border="0" align="center" width=83%>
        <tr>
            <td style="text-align: center; text-transform: uppercase;">
                <b style="text-transform: uppercase"><i>== data tersebut adalah orang yang sama ==</i></b>
            </td>
        </tr>
        <tr>
            <td style="text-align: justify;">
                &nbsp;&nbsp;&nbsp;Keterangan ini dipergunakan untuk : {{ $ajuan->keterangan }}. Demikian keterangan ini, untuk dipergunakan sebagaimna mestinya.
            </td>
        </tr>
    </table>
